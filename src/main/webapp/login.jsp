...
<body>
    ...
    <section class="contact-clean">
        <form method="post" action="ReturningUser.jsp" >
            ...
            <div style="text-align: center;"><a href="Register.jsp">Don't Have an account? Register</a></div>
             <div style="text-align: center;"><a href="adminLogin.jsp">Admin Login</a></div>
             <div style="text-align: center;"><a href="repLogin.jsp">Rep Login</a></div>
        </form>
    </section>

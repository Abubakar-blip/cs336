...
<body>
	...
	try {
		...
		String results = "SELECT * FROM userLogin WHERE userLogin.email = " + "\"" + email + "\"" + " AND " + "userLogin.password = " + "\"" + password + "\"";
		...
		while(resultSet.next()){
			 count++;
			 name = resultSet.getString("first");
			 userEmail = resultSet.getString("email");
		}
		session.setAttribute("name", name);
		session.setAttribute("admin", "");
		session.setAttribute("rep", "");
